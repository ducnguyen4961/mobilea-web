...
export default function AdditionPPFD({ isOpen, onClose }: Props) {
  ...
  const [ppfd, setPffd] = useState<{ [key: string]: string }>({}); 
  const [addppfd, setAddppfd] = useState<{ [key: string]: string }>({});
            ...
            <div key={d} style={styles.card}>
              ...
              <div style={styles.params}>
                <div style={styles.field}>
                  <label style={styles.label}> 基準PPFD (μmol/m²/s)</label>
                  <input style={styles.input} type="number" value={ppfd[d] || ""} onChange={(e) => setPffd({...ppfd,[d]: e.target.value,})}/>
                </div>
                <div style={styles.field}>
                  <label style={styles.label}> 合計PPFD (μmol/m²/s) </label>
                  <input style={styles.input} type="number" value={addppfd[d] || ""} onChange={(e) => setAddppfd({...addppfd,[d]: e.target.value,})}/>
                </div>
                <div style={styles.field}>
