...
export default function AdditionTrans({ isOpen, onClose }: Props) {
  ...
  const [trans, setTrans] = useState<{ [key: string]: string }>({}); 
  const [addtrans, setAddtrans] = useState<{ [key: string]: string }>({});
            ...
            <div key={d} style={styles.card}>
              ...
              <div style={styles.params}>
                <div style={styles.field}>
                  <label style={styles.label}> 基準蒸散量 (g/株)</label>
                  <input style={styles.input} type="number" value={trans[d] || ""} onChange={(e) => setTrans({...trans,[d]: e.target.value,})}/>
                </div>
                <div style={styles.field}>
                  <label style={styles.label}> 合計蒸散量 (g/株) </label>
                  <input style={styles.input} type="number" value={addtrans[d] || ""} onChange={(e) => setAddtrans({...addtrans,[d]: e.target.value,})}/>
                </div>
                <div style={styles.field}>
